    ...
    <div className="space-y-8">
      ...
      <section className="p-6 bg-primary/5 border border-primary/20 rounded-xl">
        <p className="text-muted-foreground">
          ...
          the <strong>REST API</strong>. All methods trigger the same 115-tool analysis and produce
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4 p-4 border rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Click "Start Scan" and watch 115 tools analyze your application in under 60 seconds.
              </p>
            </div>
          </div>
        </div>
