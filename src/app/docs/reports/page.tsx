    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-primary/10 border-2 border-primary/30 rounded-xl">
        ...
        <p className="text-muted-foreground mb-4">
          Running 25 tools gives you 25 different reports in 25 different formats. Our AI combines everything into one readable report with plain English explanations—no security PhD required.
        </p>
      ...
      <section className="p-6 bg-primary/5 border border-primary/20 rounded-xl">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          (25 tools) into a single unified report. No more switching between dashboards.
        </p>
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-background rounded-lg border">
            ...
            <p className="text-sm text-muted-foreground">
              Deduplicated findings from 25 tools, prioritized issues, plain English explanations
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground mb-6">
          25 analysis tools run in parallel. Findings are deduplicated, conflicts resolved, and presented in plain English.
        </p>
        ...
        <div className="border rounded-xl overflow-hidden bg-card">
          ...
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-6 border-b">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <div className="text-sm text-muted-foreground">25 tools completed</div>
          ...
          {/* Tools Run */}
          <div className="p-6">
            <h4 className="font-semibold mb-3">Tools Executed (25)</h4>
