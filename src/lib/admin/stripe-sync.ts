      ...
      try {
        ...
        if (product.metadata.aiSummary !== undefined) {
          tierConfig.features = {
            ...
            githubAction: product.metadata.githubAction === 'true',
            ...
            vibeScore: product.metadata.vibeScore !== 'false',
            vibeScoreBadge: product.metadata.vibeScoreBadge === 'true',
            oneClickFixes: product.metadata.oneClickFixes === 'true',
            aiReviewMerge: product.metadata.aiReviewMerge === 'true',
            shipItMode: product.metadata.shipItMode === 'true',
            learningMode: product.metadata.learningMode !== 'false',
            repoHealthProfile: product.metadata.repoHealthProfile === 'true',
            explainCodebase: product.metadata.explainCodebase === 'true',
            trustBadge: product.metadata.trustBadge !== 'false',
            teamDashboard: product.metadata.teamDashboard === 'true',
