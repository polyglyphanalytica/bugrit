...
This document describes how to keep the 79 external scanning tools updated and protected from deprecated versions.

## Overview

| Type | Count | Update Method |
|------|-------|---------------|
| npm packages | 26 | Renovate/Dependabot |
| Docker images | 53 | Manual version pinning |
