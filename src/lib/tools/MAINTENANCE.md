...
This document describes how to keep the 68 external scanning tools updated and protected from deprecated versions.

## Overview

| Type | Count | Update Method |
|------|-------|---------------|
| npm packages | 25 | Renovate/Dependabot |
| Docker images | 43 | Manual version pinning |
